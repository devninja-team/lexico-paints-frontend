                ...
                switch (sortOrder) {
                    case 'asc' :
                        switch(field) {
                            ...
                            case "MP_FLAG" :
                                sortedArray = allVendorList.sort( function(a, b) {
                                    var nameA=a.MP_FLAG?a.MP_FLAG.toLowerCase():""
                                    var nameB=b.MP_FLAG?b.MP_FLAG.toLowerCase():""
                                    if (nameA < nameB) //sort string ascending
                                        return -1
                                    if (nameA > nameB)
                                        return 1
                            ...
                            case "VENDOR_ACTIVE" :
                                sortedArray = allVendorList.sort( function(a, b) {
                                    var nameA=a.VENDOR_ACTIVE?a.VENDOR_ACTIVE.toLowerCase():""
                                    var nameB=b.VENDOR_ACTIVE?b.VENDOR_ACTIVE.toLowerCase():""
                                    if (nameA < nameB) //sort string ascending
                                        return -1
                                    if (nameA > nameB)
                                        return 1
                    ...
                    <div className="customer-table">
                        <Table responsive>
                            ...
                            <tr>
                                ...
                                <th className="cursor-pointer" onClick={()=>handleSorting("SHIPPING_RULE")}>Shipping Rule</th>
                                <th className="cursor-pointer" onClick={()=>handleSorting("VENDOR_RATING")}>Vendor Rating</th>
                            ...
                            <tbody>
                                            ...
                                            allVendorList.filter((data) => {
                                                ...
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td>{value.MP_FLAG ? value.MP_FLAG : "-"}</td>
                                                        <td>{value.VENDOR_ACTIVE ? (value.VENDOR_ACTIVE === "1" ? "Active" : "Not Active") : "-"}</td>
                                                        <td>{value.SHIPPING_RULE ? value.SHIPPING_RULE : "-"}</td>
                                                        <td>{value.VENDOR_RATING ? value.VENDOR_RATING : "-"}</td>
                                ...
                                }
                                {
                                    vendorList && vendorList.length===0 && loadingData===false && !search? (
                                        <tr>
                                            <td colSpan="11" className="text-center">No Tier found!</td>
                                        </tr>
                                    ) :
                                    ("")
                                }
                                                ...
                                                <div className="mobile-table-td-row">
                                                    <div className="td-list d-flex justify-content-between">
                                                        ...
                                                        <div className="td">
                                                            ...
                                                            <span><strong>{value.MP_FLAG ? value.MP_FLAG : "-"}</strong></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                </div>
                                                    ...
                                                    <div className="mobile-table-footer text-right">
                                                        <label onClick={()=>handleSorting("SHIPPING_RULE")}>Shipping Rule</label>
                                                        <span>{value.SHIPPING_RULE ? value.SHIPPING_RULE : "-"}</span>
                                                    </div>
                                                    <div className="mobile-table-footer text-right">
                                                        <label onClick={()=>handleSorting("VENDOR_RATING")}>Vendor Rating</label>
                                                        <span>{value.VENDOR_RATING ? value.VENDOR_RATING : "-"}</span>
                                                    </div>
                                                    <div className="mobile-table-footer text-right">
